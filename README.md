...
- [ ] Add an email address to the `ADMINS` settings variable in `git_inspect/git_inspect/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `git_inspect/git_inspect/settings/production.py`
...
- Create a copy of ``git_inspect/settings/local.py.example``:  
  `cp git_inspect/settings/local.py.example git_inspect/settings/local.py` (remembering you should replace `git_inspect` with your project's name!).
